...
export default function Video(props) {
    ...
    useEffect(() => {
        ...
        const apiUrl = 'https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&regionCode=RU&key=AIzaSyD8T_VvpaKtek0kP65Qb3jlAVkg6qLPr2E&maxResults=17';
